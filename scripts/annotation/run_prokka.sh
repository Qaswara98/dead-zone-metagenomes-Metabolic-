...
#SBATCH -o $HOME/dead-zone-metagenomes-Metabolic-/results/annotation/prokka.%j.out
#SBATCH -e $HOME/dead-zone-metagenomes-Metabolic-/results/annotation/prokka.%j.err
